...
})({"1WcsN":[function(require,module,exports) {
...
/*!
  ...
  */ !function(t, e) {
    module.exports = e(require("8a7a91cc8b304095"));
}(this, function(t) {
    "use strict";
    function e(t) {
    ...
    function j(t, e, s, i, n) {
        ...
        const d = S(r, e.replace(T, "")), u = o ? function(t, e, s) {
            return function i(n) {
                ...
                for(let { target: r } = n; r && r !== this; r = r.parentNode)for(let a = o.length; a--;)if (o[a] === r) return n.delegateTarget = r, i.oneOff && B.off(t, n.type, e, s), s.apply(r, [
                    n
                ]);
                return null;
            };
    ...
    class wt extends q {
        ...
        dispose() {
            [
                window,
                this._dialog
            ].forEach((t)=>B.off(t, ".bs.modal")), this._backdrop.dispose(), super.dispose(), B.off(document, "focusin.bs.modal");
        }
        handleUpdate() {
            this._adjustDialog();
        }
    ...
    B.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function(t) {
        ...
        [
            "A",
            "AREA"
        ].includes(this.tagName) && t.preventDefault(), B.one(e, "show.bs.modal", (t)=>{
    ...
    B.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(t) {
        ...
        if ([
            "A",
            "AREA"
        ].includes(this.tagName) && t.preventDefault(), g(this)) return;
    ...
    const Ct = new Set([
        ...
        "src",
        "xlink:href"
    ]), kt = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i, Lt = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i, Ot = (t, e)=>{
    ...
    B.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', function(t) {
        [
            "A",
            "AREA"
        ].includes(this.tagName) && t.preventDefault(), g(this) || Ut.getOrCreateInstance(this).show();
    }), y(Ut);
    const Kt = {
        animation: "boolean",
        autohide: "boolean",
...
},{"8a7a91cc8b304095":"7unqC"}],"7unqC":[function(require,module,exports) {
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1WcsN","jrdgI"], "jrdgI", "parcelRequire2041")
